    ...
    public class CartController : Controller
    {
      ...
      [HttpGet]
         public IActionResult Search(string search)
           {
              ViewBag.Book = context.Books.Where(x => x.BookName == search || x.Publication.PublicationName == search || x.Author.AuthorName == search || search == null).ToList();
               return View(context.Books.Where(x => x.BookName == search || x.Publication.PublicationName == search || x.Author.AuthorName == search || search == null).ToList());
           }
